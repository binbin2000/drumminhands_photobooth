...
frame_count = 4  # Number of photos to be taken
frame_interval = 2  # Time (seconds) between photos
camera_delay = 4  # Time (seconds) it takes for the camera to get ready after a photo has been taken.
